...
(
		{ 
	        newCompositeNode(grammarAccess.getRobotAccess().getMsgsMessageParserRuleCall_0_0()); 
	    }
		lv_msgs_0_0=ruleMessage		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getRobotAccess().getTasksTaskParserRuleCall_1_0()); 
	    }
...
(	otherlv_0='Display' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMessageAccess().getDisplayKeyword_0());
    }
(
(
...
(	otherlv_0='Task name' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTaskAccess().getTaskNameKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getTaskAccess().getTaskFreqKeyword_2_0());
    }
(
(
		lv_frequency_3_0=RULE_INT
		{
			newLeafNode(lv_frequency_3_0, grammarAccess.getTaskAccess().getFrequencyINTTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getTaskRule());
...
))?	otherlv_4='Task moves' 
    {
    	newLeafNode(otherlv_4, grammarAccess.getTaskAccess().getTaskMovesKeyword_3());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTaskAccess().getMovesMoveParserRuleCall_4_0()); 
	    }
		lv_moves_5_0=ruleMove		{
	        if ($current==null) {
...
(	otherlv_0='Move name' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMoveAccess().getMoveNameKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMoveAccess().getStartKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMoveAccess().getStartConditionParserRuleCall_2_1_0()); 
	    }
		lv_start_3_0=ruleCondition		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getMoveAccess().getEndKeyword_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMoveAccess().getEndConditionParserRuleCall_3_1_0()); 
	    }
		lv_end_5_0=ruleCondition		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMoveRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getMoveAccess().getSpeedKeyword_4());
    }
(
(
		lv_seed_7_0=RULE_INT
		{
			newLeafNode(lv_seed_7_0, grammarAccess.getMoveAccess().getSeedINTTerminalRuleCall_5_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMoveRule());
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getMoveAccess().getRotationKeyword_6_0());
    }
(
(
		lv_rotation_9_0=RULE_INT
		{
			newLeafNode(lv_rotation_9_0, grammarAccess.getMoveAccess().getRotationINTTerminalRuleCall_6_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMoveRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getConditionAccess().getCondConditionValueEnumRuleCall_0()); 
	    }
		lv_cond_0_0=ruleConditionValue		{
	        if ($current==null) {
...
// Rule ConditionValue
ruleConditionValue returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='border' 
	{
        $current = grammarAccess.getConditionValueAccess().getBorderEnumLiteralDeclaration_0().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_0, grammarAccess.getConditionValueAccess().getBorderEnumLiteralDeclaration_0()); 
    }
)
    |(	enumLiteral_1='noBorder' 
	{
        $current = grammarAccess.getConditionValueAccess().getNoBorderEnumLiteralDeclaration_1().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_1, grammarAccess.getConditionValueAccess().getNoBorderEnumLiteralDeclaration_1()); 
    }
)
    |(	enumLiteral_2='lake' 
	{
        $current = grammarAccess.getConditionValueAccess().getLakeEnumLiteralDeclaration_2().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_2, grammarAccess.getConditionValueAccess().getLakeEnumLiteralDeclaration_2()); 
    }
)
    |(	enumLiteral_3='noLake' 
	{
        $current = grammarAccess.getConditionValueAccess().getNoLakeEnumLiteralDeclaration_3().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_3, grammarAccess.getConditionValueAccess().getNoLakeEnumLiteralDeclaration_3()); 
    }
));
