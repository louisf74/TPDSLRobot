	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getRobotAccess().getAlternatives(), "rule__Robot__Alternatives");
					...
					put(grammarAccess.getMoveAccess().getGroup_6(), "rule__Move__Group_6__0");
					...
					put(grammarAccess.getRobotAccess().getMsgsAssignment_0(), "rule__Robot__MsgsAssignment_0");
					put(grammarAccess.getRobotAccess().getTasksAssignment_1(), "rule__Robot__TasksAssignment_1");
					...
					put(grammarAccess.getTaskAccess().getFrequencyAssignment_2_1(), "rule__Task__FrequencyAssignment_2_1");
					put(grammarAccess.getTaskAccess().getMovesAssignment_4(), "rule__Task__MovesAssignment_4");
					put(grammarAccess.getMoveAccess().getNameAssignment_1(), "rule__Move__NameAssignment_1");
					put(grammarAccess.getMoveAccess().getStartAssignment_2_1(), "rule__Move__StartAssignment_2_1");
					put(grammarAccess.getMoveAccess().getEndAssignment_3_1(), "rule__Move__EndAssignment_3_1");
					put(grammarAccess.getMoveAccess().getSeedAssignment_5(), "rule__Move__SeedAssignment_5");
					put(grammarAccess.getMoveAccess().getRotationAssignment_6_1(), "rule__Move__RotationAssignment_6_1");
					put(grammarAccess.getConditionAccess().getCondAssignment(), "rule__Condition__CondAssignment");
